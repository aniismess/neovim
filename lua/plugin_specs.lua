...
local plugin_specs = {
  ...
  -- Main markdown syntax and feature plugin
  {
    "gabrielelana/vim-markdown",
    dependencies = {
      "godlygeek/tabular", -- For table formatting
    },
    init = function()
      -- Enable folding for markdown files
      vim.g.markdown_enable_folding = 1

      -- Enable concealing for a cleaner look
    ...
    config = function()
      require("cord").setup({
        ...
        idle = {
          ...
          state = nil,
          tooltip = "",
          icon = "default idle icon",
        },
        text = {
          default = nil,
          workspace = "Gooning on %s",
        ...
        buttons = {
          {
            label = "GitHub",
            url = "https://github.com/aniismess",
          },
        },
        assets = {},
        variables = nil,
