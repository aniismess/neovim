...
This repo hosts a Nvim configuration for Linux, macOS, and Windows.
...
The configurations are heavily documented to make it as clear as possible.
...
For more UI demos, check the issues page.
